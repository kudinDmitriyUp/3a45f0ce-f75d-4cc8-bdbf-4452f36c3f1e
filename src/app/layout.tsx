...
export const metadata: Metadata = {
  title: "Sara - Quit Vaping Now | Health Warning & Support",
  description: "Sara, discover the shocking health risks of vaping and get support to quit. Real stories, proven methods, free resources.",
  keywords: "quit vaping, vaping health risks, nicotine addiction, quit smoking support, lung health, Sara quit vaping",
  metadataBase: new URL("https://quitvapingsara.com"),
  alternates: {
    canonical: "https://quitvapingsara.com"
  },
  openGraph: {
    title: "Sara - It's Time to Quit Vaping",
    description: "Your health is at risk. Get the facts and support you need to quit vaping for good.",
    siteName: "Quit Vaping Sara",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763407592833-mq35yjh3.jpg",
      alt: "Health impact of vaping"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Sara - Quit Vaping Now",
    description: "Discover the health risks and get support to quit vaping today",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763407592833-mq35yjh3.jpg"]
  },
  robots: {
    index: true,
    follow: true
